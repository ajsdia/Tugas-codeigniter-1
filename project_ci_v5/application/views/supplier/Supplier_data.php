                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <input type="text" name="phone" id="phone" class="form-control" style="margin-bottom: 5px;" maxlength="15" autofocus>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="description" class="col-form-label">Description <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col md-8 col-xs-8">
                                            <textarea name="description" id="description" class="form-control" style="margin-bottom: 5px;" maxlength="100" autofocus onkeyup="this.value = this.value.capitalize()">
                                            </textarea>
                                            <div class="invalid-feedback inv-description">
                                                &nbsp;
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function tambahData() {
        ...
        $("#myModal").find('.modal-title').text('Add supplier');
        $("#myModal").modal('show', {
            backdrop: 'true'
        });
    ...
    function simpandata() {
        if ($.trim($("#name").val()) == "") {
            ...
            $(".inv-description").html("Description tidak boleh kosong!");
            $('#description').addClass('is-invalid');
        } else if ($.trim($("#phone").val()) == "") {
            $(".inv-phone").html("Phone tidak boleh kosong!");
            ...
            if (dsState == "Input") {
                $.ajax({
                    ...
                    success: function(result) {
                        if (result == "ADA") {
                            //console.log(result);
                            $('.nama-ada').html("Nama supplier sudah ada!");
                            $('.nama-ada').show();
                        } else {
                            // console.log(result);
                            $('#message').html("");
