...
<head>
    ...
    <title>Project_Ci_V2 | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url('assets/template/admin') ?>/index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Project_<b>Ci</b></span>
            </a>
...
<!--                         <li class="nav-item">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?= date('Y'); ?> <a href="http://adminlte.io">myProject</a>.</strong> Web. Programming II.
        </footer>
