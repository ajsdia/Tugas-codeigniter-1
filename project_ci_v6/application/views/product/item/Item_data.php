                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <input type="number" name="stock" id="stock" class="form-control" style="margin-bottom: 5px;" maxlength="100" autofocus>
                                            <div class="invalid-feedback inv-stock">
                                                &nbsp;
                                            </div>
                                        </div>
                                    </div>
                                ...
                                foreach ($item as $i) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;width:200px;">
                                            <a onclick="editData(<?= $i->id; ?>)" style="margin-bottom:4px;color:white;" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
